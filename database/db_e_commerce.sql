...
CREATE TABLE IF NOT EXISTS `coupon_usages` (
  ...
  CONSTRAINT `coupon_usages_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE
  SET
    NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `exports` (
  ...
  CONSTRAINT `fk_exports_user` FOREIGN KEY (`requested_by`) REFERENCES `users` (`id`) ON DELETE
  SET
    NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `inventories` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_inventories_warehouse_variant` (`warehouse_id`, `variant_id`),
  KEY `fk_inventories_variant` (`variant_id`),
  CONSTRAINT `fk_inventories_variant` FOREIGN KEY (`variant_id`) REFERENCES `product_variants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_inventories_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 5 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

-- Dumping data for table db_e_commerce.inventories: ~4 rows (approximately)
INSERT INTO
  `inventories` (
    `id`,
    `warehouse_id`,
...
CREATE TABLE IF NOT EXISTS `inventory_movements` (
  ...
  `warehouse_id` bigint unsigned NOT NULL,
  `variant_id` bigint unsigned NOT NULL,
  `type` enum('in', 'out', 'adjustment', 'reservation', 'release') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `inventory_movements_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE
  SET
    NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
VALUES
  ...
  (
    4,
    '2026_08_27_022956_create_customer_addresses_table',
    2
  ),
  (
    131,
    '2026_08_31_030715_add_foreign_keys_to_permission_role_table',
    4
  ),
  (
    132,
    '2026_08_31_030715_add_foreign_keys_to_role_user_table',
    4
  ),
  (133, '2026_08_31_000001_create_brands_table', 5),
  (
    134,
    '2026_08_31_000002_create_products_table',
    5
  ),
  (
    135,
    '2026_08_31_000003_create_product_options_table',
    5
  ),
  (
    136,
    '2026_08_31_000004_create_product_option_values_table',
    5
  ),
  (
    137,
    '2026_08_31_000005_create_product_variants_table',
    5
  ),
  (
    138,
    '2026_08_31_000006_create_product_images_table',
    5
  ),
  (
    139,
    '2026_08_31_000007_create_categories_table',
    5
  ),
  (
    140,
    '2026_08_31_000008_create_category_product_table',
    5
  ),
  (
    141,
    '2026_08_31_000009_create_product_variant_option_values_table',
    5
  ),
  (142, '2026_08_31_000010_create_carts_table', 5),
  (
    143,
    '2026_08_31_000011_create_cart_items_table',
    5
  ),
  (144, '2026_08_31_000012_create_orders_table', 5),
  (
    145,
    '2026_08_31_000013_create_order_items_table',
    5
  ),
  (
    146,
    '2026_08_31_000014_create_order_addresses_table',
    5
  ),
  (
    147,
    '2026_08_31_000015_create_order_status_histories_table',
    5
  ),
  (
    148,
    '2026_08_31_000016_create_payments_table',
    5
  ),
  (149, '2026_08_31_000017_create_coupons_table', 5),
  (
    150,
    '2026_08_31_000018_create_coupon_products_table',
    5
  ),
  (
    151,
    '2026_08_31_000019_create_coupon_categories_table',
    5
  ),
  (
    152,
    '2026_08_31_000020_create_coupon_usages_table',
    5
  ),
  (
    153,
    '2026_08_31_000021_create_shipping_methods_table',
    5
  ),
  (
    154,
    '2026_08_31_000022_create_product_reviews_table',
    5
  ),
  (
    157,
    '2026_09_01_080001_add_stock_to_product_variants_table',
    6
  ),
  (
    158,
    '2026_08_31_030712_create_warehouses_table',
    7
  ),
  (
    159,
    '2026_08_31_030712_create_promotions_table',
    8
  ),
  (
    160,
    '2026_08_31_030712_create_webhook_logs_table',
    9
  ),
  (161, '2026_08_31_030712_create_pages_table', 10),
  (
    162,
    '2026_08_31_030712_create_payment_transactions_table',
    11
  ),
  (
    163,
    '2026_08_31_030712_create_refunds_table',
    12
  ),
  (
    164,
    '2026_08_31_030712_create_returns_table',
    13
  ),
  (
    165,
    '2026_08_31_030712_create_wishlists_table',
    14
  ),
  (
    166,
    '2026_08_31_030712_create_exports_table',
    15
  ),
  (
    167,
    '2026_08_31_030712_create_settings_table',
    16
  ),
  (
    168,
    '2026_08_31_030712_create_customer_notes_table',
    17
  ),
  (
    169,
    '2026_08_31_030712_create_inventories_table',
    18
  ),
  (
    170,
    '2026_08_31_030712_create_inventory_movements_table',
    19
  ),
  (
    171,
    '2026_08_31_030712_create_stock_reservations_table',
    20
  ),
  (
    172,
    '2026_08_31_030712_create_shipments_table',
    21
  ),
  (
    173,
    '2026_08_31_030712_create_shipment_items_table',
    22
  ),
  (
    174,
    '2026_08_31_030712_create_refund_items_table',
    23
  ),
  (
    175,
    '2026_08_31_030712_create_return_items_table',
    24
  ),
  (
    176,
    '2026_08_31_030712_create_promotion_rules_table',
    25
  ),
  (
    177,
    '2026_08_31_030712_create_promotion_actions_table',
    26
  ),
  (
    178,
    '2026_08_31_030712_create_wishlist_items_table',
    27
  ),
  (
    179,
    '2026_08_31_030715_add_foreign_keys_to_payment_transactions_table',
    28
  ),
  (
    180,
    '2026_08_31_030715_add_foreign_keys_to_refunds_table',
    29
  ),
  (
    181,
    '2026_08_31_030715_add_foreign_keys_to_returns_table',
    30
  ),
  (
    182,
    '2026_08_31_030715_add_foreign_keys_to_wishlists_table',
    31
  ),
  (
    183,
    '2026_08_31_030715_add_foreign_keys_to_exports_table',
    32
  ),
  (
    184,
    '2026_08_31_030715_add_foreign_keys_to_customer_notes_table',
    33
  ),
  (
    185,
    '2026_08_31_030715_add_foreign_keys_to_inventories_table',
    34
  ),
  (
    186,
    '2026_08_31_030715_add_foreign_keys_to_inventory_movements_table',
    35
  ),
  (
    187,
    '2026_08_31_030715_add_foreign_keys_to_stock_reservations_table',
    36
  ),
  (
    188,
    '2026_08_31_030715_add_foreign_keys_to_shipments_table',
    37
  ),
  (
    189,
    '2026_08_31_030715_add_foreign_keys_to_shipment_items_table',
    38
  ),
  (
    190,
    '2026_08_31_030715_add_foreign_keys_to_refund_items_table',
    39
  ),
  (
    191,
    '2026_08_31_030715_add_foreign_keys_to_return_items_table',
    40
  ),
  (
    192,
    '2026_08_31_030715_add_foreign_keys_to_promotion_rules_table',
    41
  ),
  (
    193,
    '2026_08_31_030715_add_foreign_keys_to_promotion_actions_table',
    42
  ),
  (
    194,
    '2026_08_31_030715_add_foreign_keys_to_wishlist_items_table',
    43
  ),
  (
    195,
    '2026_09_03_040355_add_reason_and_created_by_to_inventory_movements_table',
    44
  );
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `fulfillment_status` enum(
    ...
    'fulfilled',
    'returned'
  ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unfulfilled',
...
CREATE TABLE IF NOT EXISTS `order_status_histories` (
  ...
  CONSTRAINT `order_status_histories_changed_by_foreign` FOREIGN KEY (`changed_by`) REFERENCES `users` (`id`) ON DELETE
  SET
    NULL,
...
CREATE TABLE IF NOT EXISTS `payment_transactions` (
  ...
  `provider_tx_id` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` bigint unsigned NOT NULL,
...
INSERT INTO
  `permissions` (`id`, `name`, `slug`, `created_at`, `updated_at`)
VALUES
  (
    1,
    'Manage Products',
...
VALUES
  (
    1,
    NULL,
    'Vortix Apex Pro Wireless Headset (Updated V2)',
    'vortix-apex-pro-wireless-headset-updated-v2',
    'simple',
    'published',
    'Headset gaming nirkabel tingkat profesional dengan audio 7.1 surround.',
    'Vortix Apex Pro menghadirkan suara berkualitas studio dengan latensi rendah 2.4GHz.',
    'Vortix Apex Pro Wireless Headset - VGS',
    'Beli Vortix Apex Pro Wireless Headset di Vortix Gaming Store.',
    '2026-08-31 19:36:27',
    NULL,
    '2026-08-31 19:36:27',
    '2026-08-31 19:36:27'
  ...
  (
    2,
    14,
    'Vortix Wireless Pro RGB Headset',
    'vortix-wireless-pro-rgb-headset',
    'simple',
    'published',
    'Headset nirkabel 2.4GHz ultra-low latency dengan driver neodinium 50mm.',
    'Vortix Wireless Pro RGB menghadirkan kenyamanan busa memori premium, suara surround 7.1 presisi tinggi, dan pencahayaan RGB yang dapat disesuaikan.',
    NULL,
    NULL,
    '2026-08-31 19:36:57',
    NULL,
  ...
  (
    3,
    15,
    'Hyperion Strike X Mechanical Keyboard',
    'hyperion-strike-x-mechanical-keyboard',
    'simple',
    'published',
    'Keyboard mekanik TKL dengan sakelar hotswap Red Linear dan piringan aluminium.',
    'Performa respon secepat kilat dengan sakelar mekanikal yang siap untuk pertempuran eSports terberat.',
    NULL,
    NULL,
    '2026-08-31 19:36:57',
    NULL,
  ...
  (
    4,
    16,
    'CyberTech Viper Lightweight Mouse',
    'cybertech-viper-lightweight-mouse',
    'simple',
    'published',
    'Mouse gaming ultra-ringan 58 gram dengan sensor optik 26.000 DPI.',
    'Didesain khusus untuk pemain FPS yang membutuhkan kecepatan gerakan tanpa hambatan dan akurasi pixel-perfect.',
    NULL,
    NULL,
    '2026-08-31 19:36:57',
    NULL,
  ...
  (
    5,
    14,
    'Vortix OLED Curved 240Hz Gaming Monitor',
    'vortix-oled-curved-240hz-gaming-monitor',
    'simple',
    'published',
    'Layar OLED 27 inci 1440p 240Hz 0.03ms respon time.',
    'Pengalaman visual imersif tanpa tanding dengan rasio kontras tak terhingga dan warna hitam pekat sempurna.',
    NULL,
    NULL,
    '2026-08-31 19:36:57',
    NULL,
  ...
  (
    7,
    NULL,
    'Produk Uji Stock Test',
    'produk-uji-stock',
    'simple',
    'draft',
    NULL,
    'Produk uji untuk verifikasi fitur stock.',
    NULL,
    NULL,
    NULL,
    '2026-09-01 21:01:10',
...
VALUES
  (
    ...
    1,
    NULL,
    'products/test_apex_pro_main.jpg',
    'Vortix Apex Pro Wireless Headset',
    0,
    1,
    NULL
  ),
  (
    ...
    1,
    NULL,
    'products/test_apex_pro_side.jpg',
    'Vortix Apex Pro Wireless Headset',
    1,
    0,
    NULL
  ...
  (
    ...
    6,
    NULL,
    'products/rslfXR5lUPEwWK3T8F2kS7aAzSHAGiNpjBwDQbD6.png',
    NULL,
    0,
    1,
    NULL
  ...
  (
    ...
    6,
    NULL,
    'products/1tewjxbP8njHf0xuNVHs5AEtFHUwRF68qsJCpBz2.png',
    NULL,
    1,
    0,
    NULL
  ...
  (
    ...
    6,
    NULL,
    'products/GvQM9lU7B9oPw1YND3rhCSQ77qm7Mlfn0XMC6msk.png',
    NULL,
    2,
    0,
    NULL
  ...
  (
    ...
    6,
    NULL,
    'products/V3OqGIYUv8OUQxf67gNrQhipzheNSl0mWjlTXegl.png',
    NULL,
    3,
    0,
    NULL
  ...
  (
    ...
    7,
    NULL,
    'products/MMScWLoFTQgNvs9GQXYl9oLs2BtGxNa6bOAtRgRp.png',
    NULL,
    0,
    1,
    NULL
  ...
  (
    ...
    10,
    NULL,
    'products/2Vtmj0KYCaLg2zdGhlGs0pC0l15m0ynKhhENGaJO.png',
    NULL,
    0,
    1,
    NULL
...
CREATE TABLE IF NOT EXISTS `product_reviews` (
  ...
  CONSTRAINT `product_reviews_order_item_id_foreign` FOREIGN KEY (`order_item_id`) REFERENCES `order_items` (`id`) ON DELETE
  SET
    NULL,
...
CREATE TABLE IF NOT EXISTS `returns` (
  ...
  `status` enum(
    ...
    'received',
    'resolved'
  ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'requested',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `return_items` (
  ...
  `resolution` enum('refund', 'replacement', 'store_credit', 'rejected') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO
  `roles` (`id`, `name`, `slug`, `created_at`, `updated_at`)
VALUES
  (
    1,
    'Super Admin',
...
VALUES
  (
    'eOtVQLVYHEkH1vhlIwmTZDFcAF32zsQn9739573P',
    4,
    '127.0.0.1',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36',
    '',
    1788403445
  ),
  (
    'USeTYMXxJjpmuNEx41r8D64GMPcdWIWQ09fVj9Ue',
    NULL,
    '127.0.0.1',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36',
    'eyJfdG9rZW4iOiJwbnkwMUVNRmplWU9Rd0R3c2xvNXFBeFEwWW4xNVVqYmlyczRIMUlsIiwiX3ByZXZpb3VzIjp7InVybCI6Imh0dHA6XC9cLzEyNy4wLjAuMTo4MDAwIiwicm91dGUiOiJob21lIn0sIl9mbGFzaCI6eyJvbGQiOltdLCJuZXciOltdfX0=',
    1788401942
  ),
  (
    'Xy3QMNCypzYyNE9b3MPzWELr4DTPU5IlQZnzKfYM',
    NULL,
    '127.0.0.1',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36',
    'eyJfdG9rZW4iOiJmd28yeVp1MVZZaXBKSHVuVzJETjlNSXlBblluVmVNdlR5NkxsUDU4IiwiX3ByZXZpb3VzIjp7InVybCI6Imh0dHA6XC9cLzEyNy4wLjAuMTo4MDAwIiwicm91dGUiOiJob21lIn0sIl9mbGFzaCI6eyJvbGQiOltdLCJuZXciOltdfX0=',
    1788410729
  ),
  (
    'YWG77m478S27JB4Fi2bTTZQcDmQMME7OLdbd4vxQ',
    NULL,
    '127.0.0.1',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36',
    'eyJfdG9rZW4iOiJES0paaFl2MVVGWDFDOGQycnQxdDZ0Nm5aS1NGWnFrOWc1cFZlTGFvIiwiX3ByZXZpb3VzIjp7InVybCI6Imh0dHA6XC9cLzEyNy4wLjAuMTo4MDAwIiwicm91dGUiOiJob21lIn0sIl9mbGFzaCI6eyJvbGQiOltdLCJuZXciOltdfX0=',
    1788410775
  );
...
CREATE TABLE IF NOT EXISTS `stock_reservations` (
  ...
  `variant_id` bigint unsigned NOT NULL,
  `quantity` int NOT NULL,
  `status` enum('active', 'committed', 'released', 'expired') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `expires_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
VALUES
  (
    ...
    '085792584079',
    '$2y$12$hqEUgaQnCJYj2Xys.mC1b.N4Y1NYFBcS779POk6hi6Y4UW3sGhd46',
    'active',
    NULL,
    NULL,
    NULL,
  ...
  (
    ...
    '085792584999',
    '$2y$12$px.YL76/Zs/Jhepnahbm/.Bok.UGQPOB2UMeqRRRfNYQFZBo.AMAa',
    'active',
    NULL,
    NULL,
    NULL,
  ...
  (
    ...
    'test@example.com',
    '0812-3456-7890',
    '$2y$12$vzhMntKnJzA6zgFvVeDNl.wChZ9FDSjgFi2hsFMsuxETe2wux/A8e',
    'active',
    NULL,
    NULL,
    NULL,
  ...
  (
    ...
    'admin@vgs.test',
    '08123456789',
    '$2y$12$ZYvDkGiG9KA3JquHsJtP4O9XjE2JkS7P0K02uhe1v56Zzv/kWT9c2',
    'active',
    NULL,
    NULL,
    NULL,
...
-- Dumping data for table db_e_commerce.warehouses: ~1 rows (approximately)
INSERT INTO
  `warehouses` (
    `id`,
    `name`,
...
VALUES
  (
    ...
    'Gudang Utama',
    'MAIN',
    'Jl. Raya Mangga Dua No. 8, Jakarta Utara',
    'active',
    '2026-09-02 19:57:25',
    '2026-09-02 19:57:25'
  );
...
CREATE TABLE IF NOT EXISTS `wishlists` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'My Wishlist',
  PRIMARY KEY (`id`),
