...
description: 'Headset gaming nirkabel lossless 2.4GHz dengan driver Titanium 50mm, spatial 3D audio tuning, bantalan memory foam pendingin bernapas, dan mic peredam bising AI bersertifikasi Discord.',
    ...
    // 13. USB Type-C Cable
    {
        ...
        specifications: {
            ...
            'Kecepatan Transfer': 'Hingga 480Mbps (USB 2.0)',
            'Material': 'Nylon Braided + Aluminum Housing',
            'Chip': 'E-Marker Smart Chip',
            'Konektor': 'USB-C to USB-C',       
        },
        rating: 4.91,
        reviewCount: 180,
        stock: 60,
    ...
    },
    {
        ...
        slug: 'anker-765-usb-c-cable',
        description: 'Anker 765 USB-C Cable adalah kabel USB-C berperforma tinggi yang dirancang untuk pengisian daya cepat dan transfer data berkecepatan tinggi. Kabel ini mendukung USB 3.2 Gen 2 hingga 10Gbps dan pengisian hingga 140W, sehingga cocok digunakan untuk laptop, tablet, smartphone, dan perangkat USB-C lainnya.',
        categoryId: 13,
        images: [
            '/images/products/typec2.webp',
        ],
        price: 274000,
        compareAtPrice: null,
        specifications: {
            'Power Delivery': 'Hingga 140W, USB Power Delivery 3.1',
            'Kecepatan Transfer': 'Hingga 480Mbps',
            'Material': 'Nylon Braided',
            'Ketahanan': 'Hingga 35.000 kali tekukan',
            'Kompatibilitas': 'Perangkat USB-C seperti Laptop, Tablet, dan Smartphone',         
        },
        rating: 4.79,
        reviewCount: 88,
        stock: 50,
    ...
    // 14. Desk Mat
    {
        ...
        slug: 'Colta Desk Mat Pro Mouse Pad',
        description: 'Desk mat premium berbahan kulit sintetis dengan permukaan halus dan luas, dirancang untuk memberikan pergerakan mouse yang nyaman sekaligus melindungi permukaan meja dari goresan dan noda.',
        categoryId: 14,
        images: [
            '/images/products/desk_mat.jpg'
        ],
        price: 369000,
    ...
    'Permukaan': 'Smooth Leather Surface',
    'Base': 'Anti-Slip',
    'Tepi': 'Stitched Edge',
    'Fungsi': 'Mouse Pad + Desk Protector',
    'Kompatibilitas': 'Mouse, Keyboard, Laptop',
        },
        rating: 4.93,
        reviewCount: 245,
        stock: 75,
    ...
    },
    {
        ...
        slug: 'CUTTING MAT Gaming Mousepad Deskmat',
        description: 'Deskmat gaming berukuran luas dengan permukaan yang nyaman untuk pergerakan mouse, sekaligus memberikan perlindungan pada permukaan meja. Cocok untuk setup gaming maupun workstation.',
        categoryId: 14,
        images: [
    ...
    'Tipe': 'Gaming Deskmat',
    'Permukaan': 'Smooth Mouse Tracking Surface',
    'Base': 'Anti-Slip',
    'Tepi': 'Reinforced Edge',
    'Ukuran': 'Extended Desk Size',
    'Fungsi': 'Mouse Pad + Desk Protector',
    'Kompatibilitas': 'Mouse + Keyboard',
        },
        rating: 4.87,
        reviewCount: 112,
        stock: 45,
